...
{
    public abstract class SealedConstructor<T_Data, T_Entity, T_Constructor> : Singleton<T_Constructor>
        where T_Data : struct
        where T_Entity : class
        where T_Constructor : SealedConstructor<T_Data, T_Entity, T_Constructor>, new()
    {
