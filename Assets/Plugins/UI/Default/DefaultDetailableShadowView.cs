...
{
    public class DefaultDetailableShadowView : 
        IDetailableShadowView
    {
        ...
        protected virtual int ShadowObjID { get; } = 4;

        public DefaultDetailableShadowView()
        {
            _shadowObj = GameObject.Instantiate(ResourcesLoader.GetPrefab(ShadowObjID));
            ...
            _iconRectTransform = _shadowObj.transform.Find("Icon").GetComponent<RectTransform>();
