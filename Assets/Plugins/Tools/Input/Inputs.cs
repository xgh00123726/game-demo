...
namespace GameBase.Tools
{
    public partial class Inputs
    {
        ...
        private static Dictionary<List<KeyCode>, List<KeyFunction>> _funcOfCode = new Dictionary<List<KeyCode>, List<KeyFunction>>
        {
            ...
            {new List<KeyCode> {KeyCode.F1}, new List<KeyFunction>{KeyFunction.SelectF1 } },
            {new List<KeyCode> {KeyCode.F2}, new List<KeyFunction>{KeyFunction.SelectF2 } },
            {new List<KeyCode> {KeyCode.F3}, new List<KeyFunction>{KeyFunction.SelectF3 } },
            {new List<KeyCode> {KeyCode.F4}, new List<KeyFunction>{KeyFunction.SelectF4 } },
            {new List<KeyCode> {KeyCode.F5}, new List<KeyFunction>{KeyFunction.SelectF5 } },
            {new List<KeyCode> {KeyCode.F6}, new List<KeyFunction>{KeyFunction.SelectF6 } },
            {new List<KeyCode> {KeyCode.F7}, new List<KeyFunction>{KeyFunction.SelectF7 } },
            {new List<KeyCode>{KeyCode.Alpha5}, new List<KeyFunction> { KeyFunction.Spell5 } },
            ...
            {new List<KeyCode>{ KeyCode.C },      new List<KeyFunction>{ KeyFunction.SettingYawAntiClockWise, KeyFunction.ToggleDrawColliderEnable } }, // 逆时针旋转视角
            ...
            {new List<KeyCode>{KeyCode.Mouse0}, new List<KeyFunction>{KeyFunction.MouseConfirm, KeyFunction.TestPosKey, KeyFunction.PointerSelect, KeyFunction.DrawRectTrig} },
            ...
            {new List<KeyCode>{KeyCode.LeftShift}, new List<KeyFunction>{ KeyFunction.ShiftMoveMode} },
        };
