...
namespace Instance
{
    public class EpicBonusSelectPanel : BaseViewPanel<EpicBonusSelectItem, EpicBonusSelectPanel>
    {
        protected override string PanelPrefabName => "Prefabs/UI/EpicBonusSelectPanel.prefab";
        protected override string ItemPrefabName => "Prefabs/UI/EpicBonusSelectItem.prefab";

        protected override void OnGet(EpicBonusSelectItem e)
        {
            base.OnGet(e);
