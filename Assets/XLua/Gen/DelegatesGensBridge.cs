...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp1(Instance.Shop p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp2(GameBase.Creatures.Creature p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public bool __Gen_Delegate_Imp3(GameBase.Spells.Spell p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(System.Action<Instance.Shop>))
			{
			    return new System.Action<Instance.Shop>(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(System.Action<GameBase.Creatures.Creature, int>))
			{
			    return new System.Action<GameBase.Creatures.Creature, int>(__Gen_Delegate_Imp2);
			}
